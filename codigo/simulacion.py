...
for v in vehiculos:
    ...
    auto = Vehiculo(v["modelo"], v["autonomia_km"], v["bateria_kwh"], v["Eficiencia/consumo_Wh_por_km"]) #Creamos un objeto de la clase "Vehiculo" para cada vehículo en la lista de datos y lo agregamos a la lista_vehiculos
